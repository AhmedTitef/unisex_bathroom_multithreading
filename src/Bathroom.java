...
public class Bathroom {
    ...
    private static BathroomEnum bathroom = new BathroomEnum();
    ...
    protected static class Female extends Thread {
        @Override
        public void run() {
            BathroomEnum.FemaleLock femaleLock = bathroom.getFemaleLock();
            try {
    ...
    protected static class Male extends Thread {
        @Override
        public void run() {
            BathroomEnum.MaleLock maleLock = bathroom.getMaleLock();
            try {
                maleLock.enterMale();
                TimeUnit.MILLISECONDS.sleep(rnd.nextInt(100));
            } catch (InterruptedException e) {
...
//    }
    ...
    protected static class BathroomEnum {
